...
total_time = 10*60. # seconds, to be used to get the total number of samples
...
folder_to_save = "./device1/"#folder to save  depending on what devices
data_to_validate = "" # change to actual file name
